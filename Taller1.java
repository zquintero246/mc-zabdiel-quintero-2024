...
public class Taller1 {
    ...
    public static Set<Double> leerConjunto(Scanner scanner, String numC) {
        Set<Double> conjunto = new HashSet<>();

        System.out.println("Ingrese la cantidad de numeros en el " + numC + " conjunto: ");
        int cantidad = scanner.nextInt();

        System.out.println("Ingrese los numeros en el " + numC + " conjunto: ");
